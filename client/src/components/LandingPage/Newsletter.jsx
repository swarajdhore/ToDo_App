...
import { subscribeEmail } from "../../Redux/Reducer/Email/email.action";

function Newsletter() {
  const dispatch = useDispatch();
  const handleSubmit = () =>{
    const emailid  = document.querySelector('input').value;
    try{
   var subscribed =  dispatch(subscribeEmail(emailid));
    }
    catch(err)
    {
          ...
          >
            ...
            <div className="relative flex flex-col lg:flex-row justify-between items-center">
              ...
              <div className="text-center lg:text-left lg:max-w-xl">
                <h3 className="h1 text-white mb-2 text-3xl">
                ...
                <form className="w-full lg:w-auto">
                  <div  className="flex flex-col sm:flex-row justify-center max-w-xs mx-auto sm:max-w-md lg:mx-0">
                    ...
                    <button
                      ...
                      className="p-2  btn text-white rounded-md bg-blue-600 hover:bg-blue-700 shadow"
                      href="#0"
                    >
                      Subscribe
                    </button>
