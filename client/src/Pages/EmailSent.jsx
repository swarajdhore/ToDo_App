  ...
  return (
    <div className="flex items-center justify-center min-h-screen p-5 bg-gray-600 min-w-screen">
      <div className="max-w-xl p-8 text-center text-gray-800 bg-white shadow-xl lg:max-w-3xl rounded-3xl lg:p-12">
        <h3 className="text-2xl">Thanks for signing up for Tasky!</h3>
        ...
        <p>
          Please verify your email through the link sent to your registered
          email id.
        </p>
        <div className="mt-4">
          {/* <button className=" text-blue-200 bg-blue-600 rounded">
          ...
          <p className="mt-4 text-sm">
            ...
            <div className="mt-4">
              <button
                type="submit"
                onClick={submit}
                className="px-2 py-2 rounded-xl text-white transition ease-in-out delay-150 bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300 ..."
              >
                Resend Email
              </button>
            </div>
